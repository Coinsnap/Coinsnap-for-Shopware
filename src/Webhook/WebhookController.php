...
class WebhookController extends AbstractController
{
    ...
    #[Route(path: '/api/_action/coinsnap/webhook-endpoint', name: 'api.action.coinsnap.webhook.endpoint', methods: ['POST'], defaults: ['XmlHttpRequest' => true, 'auth_required' => false])]
